...
import { Search, User, Clock, AlertCircle, CheckCircle, XCircle, MessageSquare, MoreVertical } from 'lucide-react';
      ...
      <header className="border-b border-slate-700 bg-slate-900/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-purple-600 rounded-lg flex items-center justify-center font-bold text-lg">
              V
            </div>
            <div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-slate-700 rounded-lg focus:outline-none focus:border-violet-500 text-white placeholder-slate-400"
            />
          </div>
        ...
        <div className="space-y-3">
          {filteredTickets.map((ticket) => (
            <div
              key={ticket.id}
              className="bg-slate-800/30 border border-slate-700 rounded-xl p-5 hover:bg-slate-800/50 transition-all cursor-pointer backdrop-blur-sm"
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-lg font-semibold mb-2 text-white">{ticket.title}</h3>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {ticket.status !== 'resolved' && (
                    <select
                      ...
                      className="px-3 py-1.5 bg-slate-700 border border-slate-600 rounded-lg text-sm text-white focus:outline-none focus:border-violet-500"
